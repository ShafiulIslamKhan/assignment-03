    ...
    <?php
        ...
        if( isset($_POST['convert']) ){
            ...
            $convert_currency = $_POST['convert_currency'];
             ...
             if( empty($amount) || empty($currency) || empty($convert_currency) ){
                ...
                $msg = currencyConverterBasic($amount, $currency, $convert_currency);
            ...
            <div class="col-md-5">
                <div class="my-3">
                    <div class="card shadow">
                        <img src="" alt="">
                        <div class="card-body">
                            <h2>Currency Converter Advance</h2>
                            <?php echo $msg ?? ''; ?>
                            <hr>
                            <form action="" method="POST">
                                ...
                                <label for="">Convert To</label>
                                    <select name="convert_currency" class="form-control" id="">
                                        <option value="select">-select-</option>
                                        <option value="USD">USD</option>
                                        <option value="CAD">CAD</option>
                                        <option value="POUND">POUND</option>
